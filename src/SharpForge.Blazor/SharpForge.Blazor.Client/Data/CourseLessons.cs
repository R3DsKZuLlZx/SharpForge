namespace SharpForge.Blazor.Client.Data;
...
public static class CourseLessons
{
    ...
    [
        new(1, "Introduction to Patterns", "/training/design-patterns/lesson/1"),
        new(2, "Singleton", "/training/design-patterns/lesson/2"),
        new(3, "Factory Method", "/training/design-patterns/lesson/3"),
        new(4, "Abstract Factory", "/training/design-patterns/lesson/4"),
        new(5, "Builder", "/training/design-patterns/lesson/5"),
        new(6, "Prototype", "/training/design-patterns/lesson/6"),
        new(7, "Adapter", "/training/design-patterns/lesson/7"),
        new(8, "Bridge", "/training/design-patterns/lesson/8"),
        new(9, "Composite", "/training/design-patterns/lesson/9"),
        new(10, "Decorator", "/training/design-patterns/lesson/10"),
        new(11, "Facade", "/training/design-patterns/lesson/11"),
        new(12, "Flyweight", "/training/design-patterns/lesson/12"),
        new(13, "Proxy", "/training/design-patterns/lesson/13"),
        new(14, "Chain of Responsibility", "/training/design-patterns/lesson/14"),
        new(15, "Command", "/training/design-patterns/lesson/15"),
        new(16, "Iterator", "/training/design-patterns/lesson/16"),
        new(17, "Mediator", "/training/design-patterns/lesson/17"),
        new(18, "Memento", "/training/design-patterns/lesson/18"),
        new(19, "Observer", "/training/design-patterns/lesson/19"),
        new(20, "State", "/training/design-patterns/lesson/20"),
        new(21, "Strategy", "/training/design-patterns/lesson/21"),
        new(22, "Template Method", "/training/design-patterns/lesson/22"),
        new(23, "Visitor", "/training/design-patterns/lesson/23"),
        new(24, "Patterns in Practice", "/training/design-patterns/lesson/24")
    ];
